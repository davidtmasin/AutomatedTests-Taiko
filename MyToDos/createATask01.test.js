...
(async () => {
  try {
    ...
    await screenshot({path: './screenshots/Cenario 01 - 01.png'}, {path: 'screenshot'}, { fullPage: true })
    ...
    await screenshot({path: './screenshots/Cenario 01 - 02.png'}, { fullPage: true })
    ...
    await screenshot({path: './screenshots/Cenario 01 - 03.png'}, { fullPage: true })
    ...
    await screenshot({path: './screenshots/Cenario 01 - 04.png'}, { fullPage: true })
